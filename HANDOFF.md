...
LAST CHANGE      §31 — MY FIXTURE AND MY ENGINE HAD DRIFTED, and A shipped a page
                 against the stale shape. Fixture is now GENERATED by the engine
                 and check.sh fails on drift. A: your page needs a regen.
